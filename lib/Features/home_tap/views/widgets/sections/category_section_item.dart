...
class CategoriesItemsSection extends StatelessWidget {
  const CategoriesItemsSection({
    super.key, required this.itemCount,required this.getCategoryList,
    ...
    return SizedBox(
      ...
      child: GridView.builder(
       ...
       itemBuilder: (context,index){
        ...
        return Column(
          children: [
            ClipOval(child: Image.network(categoryList.image ?? 'https://cdn.pixabay.com/photo/2015/06/09/16/12/error-803716_640.png',fit: BoxFit.fill,width: 100,height: 100,),),
